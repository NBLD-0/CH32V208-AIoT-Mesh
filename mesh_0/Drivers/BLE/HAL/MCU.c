...
tmosTaskID halTaskID_key;
tmosTaskID halTaskID_hcsr501;
tmosTaskID halTaskID_dht22;
tmosTaskID halTaskID_bh1750;
tmosTaskID halTaskID_mq2;
tmosTaskID halTaskID_sw420;
/*******************************************************************************
...
void HAL_Init()
{
    ...
    halTaskID_key = TMOS_ProcessEventRegister(MyTask);
    halTaskID_hcsr501 = TMOS_ProcessEventRegister(My_HC_SR501_Task);
    halTaskID_dht22 = TMOS_ProcessEventRegister(My_DHT22_Task);
    halTaskID_bh1750 = TMOS_ProcessEventRegister(My_BH1750_Task);
    halTaskID_mq2 = TMOS_ProcessEventRegister(My_MQ2_Task);
    halTaskID_sw420 = TMOS_ProcessEventRegister(My_SW_Task);
    HAL_TimeInit();
#if(defined HAL_SLEEP) && (HAL_SLEEP == TRUE)
    HAL_SleepInit();
#endif
    ...
    tmos_start_task(halTaskID, HAL_REG_INIT_EVENT, MS1_TO_SYSTEM_TIME(BLE_CALIBRATION_PERIOD)); 
    tmos_start_task(halTaskID_key, MY_TASK_EVENT, MS1_TO_SYSTEM_TIME(10));
//    tmos_start_task(halTaskID_hcsr501, MY_HC_SR_TASK_EVENT, MS1_TO_SYSTEM_TIME(100));
//    tmos_start_task(halTaskID_dht22, MY_DHT22_TASK_EVENT, MS1_TO_SYSTEM_TIME(300));
//    tmos_start_task(halTaskID_bh1750, MY_BH1750_TASK_EVENT, MS1_TO_SYSTEM_TIME(150));
//    tmos_start_task(halTaskID_mq2, MY_MQ2_ADC_TASK_EVENT, MS1_TO_SYSTEM_TIME(100));
//    tmos_start_task(halTaskID_sw420, MY_SW_TASK_EVENT, MS1_TO_SYSTEM_TIME(100));
#endif
