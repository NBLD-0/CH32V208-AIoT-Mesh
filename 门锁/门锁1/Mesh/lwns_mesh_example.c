...
#define MESH_TEST_SELF_ADDR_IDX    4  //当前测试中节点地址，在device_addr数组中
...
void lwns_mesh_send_door_open(void)
{
    memset(User_TxData, 0, sizeof(User_TxData));
    memcpy(User_TxData, "DOOR_OPEN", 9);
